...
abstract class AppLocalizations {
  ...
  ///
  /// In en, this message translates to:
  /// **'City name, or leave empty for all regions'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Enter a city name or search all regions'**
  String get initialPrompt;

  /// No description provided for @initialExample.
  ///
  /// In en, this message translates to:
  /// **'e.g. Taipei City — or leave empty to see all'**
  ...
  /// No description provided for @allRegionsTitle.
  ///
  /// In en, this message translates to:
  /// **'All Taiwan — 36-hour Forecast'**
  String get allRegionsTitle;
